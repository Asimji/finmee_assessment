       ...
       <Flex pr={{lg:'8vh'}} direction={{lg:'row',base:'column'}}>
        <Box p={'6vh'} w={'100%'}>
            <Heading textColor={'#FF3A2D'}
             ...
             fontSize={{lg:'7vh',base:'4vh'}}
             className='heading'
            >
            Mine-To-Mill-To-Mine <br /><br /> Optimization
            </Heading>
            <Text fontFamily={customStyles} textAlign={'justify'} mt={'5vh'}
...
<Flex pr={{lg:'8vh'}} direction={{lg:'row',base:'column'}}  mt={{lg:'10vh',base:'2vh'}}>
        <Box p={'6vh'} w={'100%'} mt={{lg:'10vh'}}>
            <Heading textColor={'#FF3A2D'}
...
<Flex pl={{lg:'6vh'}} mt={'10vh'} direction={{lg:'row',base:'column'}}> 
        ...
        <Box p={'6vh 8vh 6vh 6vh'} w={'90%'} mt={{lg:'10vh'}} >
            <Heading textColor={'#FF3A2D'}
